...
class InstructionScreen extends React.Component {
    ...
    async componentDidMount() {
        this.willFocusSubscription = this.props.navigation.addListener('willFocus', async () => {
            ...
            this.setState({
                loaderInstruction: res.data.loader_instruction,
                driverInstruction: res.data.driver_instruction,
            });
        });
    }
            ...
            <ScrollView contentInsetAdjustmentBehavior="automatic">
                    ...
                    HiddenComponent={
                        <Fragment>
                            <View style={styles.cardDescription}>
                                <Text style={styles.instructionText}>{this.state.loaderInstruction}</Text>
                            </View>
                        </Fragment>
                    }
                ...
                <ExpandCardBase
                    ...
                    HiddenComponent={
                        <Fragment>
                            <View style={styles.cardDescription}>
                                <Text style={styles.instructionText}>{this.state.driverInstruction}</Text>
                            </View>
                        </Fragment>
                    }
                    cardStyle={styles.cardMargins}
