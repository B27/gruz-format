			...
			<KeyboardAvoidingView keyboardVerticalOffset={85} behavior='padding'>
				{!this.state.isDriver ? (
					<View style={{ width: '90%', height: '100%', alignItems: 'center', justifyContent: 'center', alignSelf: 'center'}}>
                        <Text style={{textAlign: 'center', fontSize: 16}}>Вы не являетесь водителем. Для того, чтобы изменять данные об автомобиле, измените специальность на экране "Моя информация" с "Грузчика" на "Водителя"</Text>
                    </View>
				) : (
